...
// ---------------------------------------------------------------------------
template <typename _DiagnosticTracker> // typename _EmmiterT
Parser<_DiagnosticTracker>::ssa Parser<_DiagnosticTracker>::parseExpr(short precedence, short indent) {
...
// ---------------------------------------------------------------------------
template <typename _DiagnosticTracker> // typename _EmmiterT
Parser<_DiagnosticTracker>::ssa Parser<_DiagnosticTracker>::parsePrimaryExpr(short indent) {
   Token t = *pos_;
   ++pos_;
   ssa expr;
   op::Kind kind;
